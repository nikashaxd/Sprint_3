...
class RegistrationLocators:
    ...
    REG_INCORRECT_PASSWORD = (By.XPATH,
                              "//p[@class='input__error text_type_main-default' and text()='Некорректный пароль']")  #Надпись Некорректный пароль
...
class LoginLocators:
    ...
    ORDER_BUTTON = (
        By.XPATH, "//button[text()='Оформить заказ']")  #Кнопка Оформить заказ на главной старнице после входа


class MainPageLocators:
    MAIN_LOGIN_BUTTON = (
        By.XPATH, "//button[text()='Войти в аккаунт']")  #Кнопка Войти в аккаунт на главной странице сайта
